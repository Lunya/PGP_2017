...
export class SidebarPage {
	...
	selectUserStories() {
		return browser.element.all(by.css('tr:nth-of-type(2) td:first-of-type button')).click()
			.then(function() {
				browser.element.all(by.css('tr:nth-of-type(3) td:first-of-type button')).click()
			})
	}
